...
- A few minor memory leaks were fixed; stack memory handling was modified in many places so the engine becomes a little more stable.
...
5) Boot your Wii, then start the game using your favorite booting method. The game is in /apps/QWRev/boot.dol in your media card. IMPORTANT: If you use the Homebrew Channel, be sure to update it to the latest version available.
