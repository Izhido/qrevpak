...
IMPORTANT: Q2CTFRev is now part of Quake Rev PAK.
...
To run Q2CTFRev as a standalone application (which we do not recommend, please use Quake Rev PAK), please do the following:
