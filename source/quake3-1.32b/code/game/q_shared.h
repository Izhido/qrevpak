...
// >>> FIX: For Nintendo Wii using devkitPPC / libogc
// These were already defined in libogc, but not with these values. Renaming:
...
#define Q_COLOR_BLACK		'0'
#define Q_COLOR_RED			'1'
#define Q_COLOR_GREEN		'2'
#define Q_COLOR_YELLOW		'3'
#define Q_COLOR_BLUE		'4'
#define Q_COLOR_CYAN		'5'
#define Q_COLOR_MAGENTA		'6'
