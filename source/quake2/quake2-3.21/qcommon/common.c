...
// Allocating in big stack. Stack in this device is pretty small:
	...
	char*		msg = Sys_BigStackAlloc(MAXPRINTMSG, "Com_Printf");
// <<< FIX
...
// Deallocating from previous fix:
		Sys_BigStackFree(MAXPRINTMSG, "Com_Printf");
// <<< FIX
		return;
	}
...
// Allocating in big stack. Stack in this device is pretty small:
		//char	name[MAX_QPATH];
		char*	name = Sys_BigStackAlloc(MAX_QPATH, "Com_Printf");
// <<< FIX
...
// >>> FIX: For Nintendo Wii using devkitPPC / libogc
// Deallocating from previous fix:
		Sys_BigStackFree(MAX_QPATH, "Com_Printf");
// <<< FIX
	}
// >>> FIX: For Nintendo Wii using devkitPPC / libogc
// Deallocating from previous fix:
...
// Allocating for previous fix in big stack:
	msg = Sys_BigStackAlloc(MAXPRINTMSG, "Com_DPrintf");
// <<< FIX
