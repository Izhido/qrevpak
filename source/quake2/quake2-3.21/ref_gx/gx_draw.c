...
void Draw_Char (int x, int y, int num)
{
	...
	qgxPosition3f32 (x, y, GXU_ORTHO_ZCOORD_MIDDLE);
	qgxColor4u8 (gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
	qgxTexCoord2f32 (fcol, frow);
	qgxPosition3f32 (x+8, y, GXU_ORTHO_ZCOORD_MIDDLE);
	qgxColor4u8 (gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
	qgxTexCoord2f32 (fcol + size, frow);
	qgxPosition3f32 (x+8, y+8, GXU_ORTHO_ZCOORD_MIDDLE);
	qgxColor4u8 (gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
	qgxTexCoord2f32 (fcol + size, frow + size);
	qgxPosition3f32 (x, y+8, GXU_ORTHO_ZCOORD_MIDDLE);
	qgxColor4u8 (gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
...
void Draw_StretchPic (int x, int y, int w, int h, char *pic)
{
	...
	qgxPosition3f32 (x+w, y, GXU_ORTHO_ZCOORD_MIDDLE);
	qgxColor4u8 (gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
	qgxTexCoord2f32 (gl->sh, gl->tl);
	qgxPosition3f32 (x+w, y+h, GXU_ORTHO_ZCOORD_MIDDLE);
	qgxColor4u8 (gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
	qgxTexCoord2f32 (gl->sh, gl->th);
	qgxPosition3f32 (x, y+h, GXU_ORTHO_ZCOORD_MIDDLE);
	qgxColor4u8 (gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
...
void Draw_Pic (int x, int y, char *pic)
{
	...
	qgxColor4u8 (gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
	qgxTexCoord2f32 (gl->sl, gl->tl);
	qgxPosition3f32 (x+gl->width, y, GXU_ORTHO_ZCOORD_MIDDLE);
	qgxColor4u8 (gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
	qgxTexCoord2f32 (gl->sh, gl->tl);
	qgxPosition3f32 (x+gl->width, y+gl->height, GXU_ORTHO_ZCOORD_MIDDLE);
	qgxColor4u8 (gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
	qgxTexCoord2f32 (gl->sh, gl->th);
	qgxPosition3f32 (x, y+gl->height, GXU_ORTHO_ZCOORD_MIDDLE);
	qgxColor4u8 (gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
	qgxTexCoord2f32 (gl->sl, gl->th);
	qgxEnd ();
}
...
void Draw_FadeScreen (void)
{
	...
	qgxPosition3f32 (0, 0, GXU_ORTHO_ZCOORD_MIDDLE);
	qgxColor4u8 (0, 0, 0, 205);
	qgxPosition3f32 (vid.width, 0, GXU_ORTHO_ZCOORD_MIDDLE);
	qgxColor4u8 (0, 0, 0, 205);
	qgxPosition3f32 (vid.width, vid.height, GXU_ORTHO_ZCOORD_MIDDLE);
	qgxColor4u8 (0, 0, 0, 205);
	qgxPosition3f32 (0, vid.height, GXU_ORTHO_ZCOORD_MIDDLE);
	qgxColor4u8 (0, 0, 0, 205);
