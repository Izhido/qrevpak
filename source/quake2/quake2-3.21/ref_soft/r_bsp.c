...
// Allocating in big stack. Stack in this device is pretty small:
	...
	mvertex_t*	bverts = Sys_BigStackAlloc((MAX_BMODEL_VERTS) * sizeof(mvertex_t), "R_DrawSolidClippedSubmodelPolygons");
	bedge_t*		bedges = Sys_BigStackAlloc((MAX_BMODEL_EDGES) * sizeof(bedge_t), "R_DrawSolidClippedSubmodelPolygons");
	bedge_t *pbedge;
// <<< FIX
...
// Deallocating from previous fix:
	Sys_BigStackFree((MAX_BMODEL_VERTS) * sizeof(mvertex_t) 
	               + (MAX_BMODEL_EDGES) * sizeof(bedge_t), "R_DrawSolidClippedSubmodelPolygons");
// <<< FIX
}
