...
// Allocating in big stack. Stack in this device is pretty small:
	...
	byte*	basespans = Sys_BigStackAlloc((MAXSPANS*sizeof(espan_t)+CACHE_SIZE) * sizeof(byte), "R_ScanEdges");
// <<< FIX
	espan_t	*basespan_p;
	surf_t	*s;
...
// Deallocating from previous fix:
	Sys_BigStackFree((MAXSPANS*sizeof(espan_t)+CACHE_SIZE) * sizeof(byte), "R_ScanEdges");
// <<< FIX
}
