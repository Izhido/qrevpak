...
extern char sys_resolution_in_brackets[MAX_STRING_CHARS + 1];

extern char sys_resolution_description[MAX_STRING_CHARS + 1];
...
// Allocating in big stack. Stack in this device is pretty small:
        ...
        char*		msg = Sys_BigStackAlloc(MAXPRINTMSG, "VID_Printf");
// <<< FIX
...
// Deallocating from previous fix:
		Sys_BigStackFree(MAXPRINTMSG, "VID_Printf");
// <<< FIX
}
