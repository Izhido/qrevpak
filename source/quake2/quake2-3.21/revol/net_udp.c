...
*/
// net_udp.c
// (Based on net_udp.c from /solaris directory, with modifications for the
// Nintendo Wii using devkitPPC / libogc)

// >>> FIX: For Nintendo Wii using devkitPPC / libogc
// Including the headers for network support for the platform:
#include <network.h>
...
#include <unistd.h>
// >>> FIX: For Nintendo Wii using devkitPPC / libogc
// Removing non-present headers (part 1):
...
#include <sys/param.h>
// >>> FIX: For Nintendo Wii using devkitPPC / libogc
// Removing non-present headers (part 2):
//#include <sys/ioctl.h>
//#include <sys/uio.h>
// <<< FIX
#include <errno.h>
// >>> FIX: For Nintendo Wii using devkitPPC / libogc
// Removing non-present headers (part 3):
//#include <sys/filio.h>
// <<< FIX
...
void NetadrToSockadr (netadr_t *a, struct sockaddr_in *s)
{
	...
	if (a->type == NA_BROADCAST)
	{
		...
		s->sin_port = a->port;
// >>> FIX: For Nintendo Wii using devkitPPC / libogc
// Adjusting for the platform's settings:
		//*(int *)&s->sin_addr = -1;
		s->sin_addr.s_addr = -1;
// <<< FIX
	}
