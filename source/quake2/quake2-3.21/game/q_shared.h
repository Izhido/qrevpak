...
// In order to make things easier when using Visual Studio, the following code was commented out (part 1):
...
// >>> FIX: For Nintendo Wii using devkitPPC / libogc
//#endif
// In order to make things easier when using Visual Studio, the following code was commented out (part 2):
// <<< FIX
...
// >>> FIX: For Nintendo Wii using devkitPPC / libogc
// bool is already defined for this platform. Also, there is no guarantee qboolean will be sizeof(int) as a enum. Replacing:
//typedef enum {false, true}	qboolean;
typedef int qboolean;
#ifndef BOOL_IMPLEMENTED
enum {false, true} qboolean_values;
#endif
...
// >>> FIX: For Nintendo Wii using devkitPPC / libogc
// Macro seems to suffice for this platform (part 1):
...
// >>> FIX: For Nintendo Wii using devkitPPC / libogc
// Macro seems to suffice for this platform (part 2):
//#endif
// <<< FIX
