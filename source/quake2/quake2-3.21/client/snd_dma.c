...
// Tuning up s_mixahead for better sound handling (thanks to Paril :) ) :
...
// Allocating in big stack. Stack in this device is pretty small:
	...
	char*			model = Sys_BigStackAlloc(MAX_QPATH, "S_RegisterSexedSound");
	char*			sexedFilename = Sys_BigStackAlloc(MAX_QPATH, "S_RegisterSexedSound");
	char*			maleFilename = Sys_BigStackAlloc(MAX_QPATH, "S_RegisterSexedSound");
// <<< FIX
...
// Adjusting for previous fix:
	...
	Com_sprintf (sexedFilename, MAX_QPATH, "#players/%s/%s", model, base+1);
// <<< FIX
...
// Adjusting for previous fix:
			...
			Com_sprintf (maleFilename, MAX_QPATH, "player/%s/%s", "male", base+1);
// <<< FIX
...
// Deallocating from previous fix:
	Sys_BigStackFree(MAX_QPATH + MAX_QPATH + MAX_QPATH, "S_RegisterSexedSound");
// <<< FIX
...
// Allocating in big stack. Stack in this device is pretty small:
	//char name[256];
	char* name = Sys_BigStackAlloc(256, "S_Play");
// <<< FIX
	sfx_t	*sfx;
