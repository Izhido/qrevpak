...
void Draw_Crosshair(void)
{
	...
	if (crosshair.value == 2) {
		...
		GX_Begin (GX_QUADS, gxu_cur_vertex_format, 4);
		GX_Position3f32(x - 4, y - 4, GXU_ORTHO_ZCOORD_MIDDLE);
		GX_Color4u8(gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
		GX_TexCoord2f32 (0, 0);
		GX_Position3f32(x+12, y-4, GXU_ORTHO_ZCOORD_MIDDLE);
		GX_Color4u8(gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
		GX_TexCoord2f32 (1, 0);
		GX_Position3f32(x+12, y+12, GXU_ORTHO_ZCOORD_MIDDLE);
		GX_Color4u8(gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
		GX_TexCoord2f32 (1, 1);
		GX_Position3f32(x - 4, y+12, GXU_ORTHO_ZCOORD_MIDDLE);
		GX_Color4u8(gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
		GX_TexCoord2f32 (0, 1);
		GX_End ();
...
void Draw_SubPic(int x, int y, qpic_t *pic, int srcx, int srcy, int width, int height)
{
	...
	GX_Position3f32(x+width, y, GXU_ORTHO_ZCOORD_MIDDLE);
	GX_Color4u8(gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
	GX_TexCoord2f32 (newsh, newtl);
	GX_Position3f32(x+width, y+height, GXU_ORTHO_ZCOORD_MIDDLE);
	GX_Color4u8(gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
	GX_TexCoord2f32 (newsh, newth);
	GX_Position3f32(x, y+height, GXU_ORTHO_ZCOORD_MIDDLE);
	GX_Color4u8(gxu_cur_r, gxu_cur_g, gxu_cur_b, gxu_cur_a);
