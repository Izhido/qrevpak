...
// Disabling the following line, to help with on-screen keyboard handling:
...
// >>> FIX: For Nintendo Wii using devkitPPC / libogc
// Re-enabling the previously commented-out line:
	scr_drawdialog = false;
// <<< FIX
...
// >>> FIX: For Nintendo Wii using devkitPPC / libogc
// If the Wii Remote is pointing to the screen, or the on-screen keyboard
// is currently active, update the whole thing, so both things won't leave 
// traces on unexpected places:
