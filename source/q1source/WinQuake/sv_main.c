...
// Allocating in big stack. Stack in this device is pretty small:
	...
	byte*		buf = Sys_BigStackAlloc(MAX_DATAGRAM, "SV_SendClientDatagram");
// <<< FIX
	sizebuf_t	msg;
...
// Compensating for local variable change:
	...
	msg.maxsize = MAX_DATAGRAM * sizeof(byte);
// <<< FIX
	msg.cursize = 0;
...
// >>> FIX: For Nintendo Wii using devkitPPC / libogc
// Deallocating from previous fix:
		Sys_BigStackFree(MAX_DATAGRAM, "SV_SendClientDatagram");
// <<< FIX
...
{
// >>> FIX: For Nintendo Wii using devkitPPC / libogc
// Default settings for this platform define chars as signed by default:
	//char	data[128];
