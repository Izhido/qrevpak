...
// >>> FIX: For Nintendo Wii using devkitPPC / libogc
// Calculating fixed16_t versions of the above:
	d_sdivzstepu16 = d_sdivzstepu * 0x10000;
	d_tdivzstepu16 = d_tdivzstepu * 0x10000;
	d_zistepu16 = d_zistepu * 0x10000;
	d_sdivzstepv16 = d_sdivzstepv * 0x10000;
	d_tdivzstepv16 = d_tdivzstepv * 0x10000;
	d_zistepv16 = d_zistepv * 0x10000;
	d_sdivzorigin16 = d_sdivzorigin * 0x10000;
	d_tdivzorigin16 = d_tdivzorigin * 0x10000;
	d_ziorigin16 = d_ziorigin * 0x10000;
// <<< FIX
...
// Allocating in big stack. Stack in this device is pretty small:
	...
	sspan_t*		spans = Sys_BigStackAlloc(sizeof(sspan_t) * (MAXHEIGHT+1), "D_DrawSprite");
// <<< FIX
